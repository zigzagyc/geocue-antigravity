...
_CueModel _$CueModelFromJson(Map<String, dynamic> json) => _CueModel(
  ...
  originalCueId: json['originalCueId'] as String?,
  referenceCueId: json['referenceCueId'] as String?,
...
Map<String, dynamic> _$CueModelToJson(_CueModel instance) => <String, dynamic>{
  ...
  'originalCueId': instance.originalCueId,
  'referenceCueId': instance.referenceCueId,
